# Productos, presentaciones y medios

Copiar este prompt en una sesión nueva de Claude Code.

---

Trabajá únicamente en **Productos, presentaciones y medios** para el frontend B2B de DISTRICO.
...
**Condición de cierre:** Producto con variante e imagen utilizable en catálogo.
...
**Continuación:** una vez cumplida la condición de cierre, indicar que la próxima tarea es 07b-precios-stock. No ejecutarla automáticamente en esta sesión.
