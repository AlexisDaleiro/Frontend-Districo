...
**Archivos relevantes:** src/components/auth.tsx, src/app/solicitar-cuenta. Consultá docs/API.md si hay llamadas al backend. No modificar la rama ni el código backend.
