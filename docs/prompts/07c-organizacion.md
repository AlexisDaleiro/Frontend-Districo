...
**Archivos relevantes:** src/components/admin.tsx, src/components/providers.tsx. Consultá docs/API.md si hay llamadas al backend. No modificar la rama ni el código backend.
